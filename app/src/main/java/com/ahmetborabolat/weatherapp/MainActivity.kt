...
import com.ahmetborabolat.weatherapp.adapter.WeatherToday
import com.ahmetborabolat.weatherapp.databinding.ActivityMainBinding
        ...
        viM.closetorexactlysameweatherdata.observe(this, Observer {
            ...
            for (i in it.weather) {
                ...
                if (i.icon == "01d") {
                    ...
                    binding.imageMain.setImageResource(R.drawable.clear)
                ...
                if (i.icon == "10n") {
                    ...
                    binding.imageMain.setImageResource(R.drawable.rain)
    ...
    private fun getCurrentLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            if (location != null) {
                ...
                val myprefs = SharedPrefs(this@MainActivity)
